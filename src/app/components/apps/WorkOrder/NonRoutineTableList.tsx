...
import { fetchWorkOrder } from '@/store/apps/WorkOrder/WorkOrderSlice';
...
const EnhancedTableToolbar = (props: EnhancedTableToolbarProps) => {
  ...
  const handleRedirect = (event:any) => {
    ...
    router.push('/maintenance/work-order/non-routine/new');
  };
  return (
    <Toolbar
      sx={{
...
const AirCraftSeriesTableList = () => {
  ...
  const getProducts: ProductType[] = useSelector((state) => state.workOrderReducer.workOrder);
